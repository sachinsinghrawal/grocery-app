...
import { Text, TextInput, View,Image, TouchableOpacity, ScrollView,StyleSheet,FlatList} from "react-native";
...
export default class Search extends Component
{
    renderItem=({item})=>{
        return(
            <View style={{width:'47.5%',height:220,backgroundColor:'#fff',marginBottom:10,marginHorizontal:5,borderRadius:10,padding:5,shadowColor:'black',elevation:5,justifyContent:'space-between'}}>

                <View style={{justifyContent:'center',alignItems:'center',height:'60%',backgroundColor:item.color,borderRadius:10,marginBottom:'5%'}}>
                    <Image source={require('../imgs/pizza.png')} style={{height:100,width:100}}/>
                </View>

                <Text style={{fontSize:RFValue(13,580),fontWeight:'600'}}>{item.title}<Text>   10kg   </Text></Text>
        ...
        return(
            <View style={{flex:1,width:'93%',alignSelf:'center',paddingTop:5}}>
                ...
                <View style={{flexDirection:'row',justifyContent:'space-between'}}>
                    <TouchableOpacity style={{width:'10%',backgroundColor:'#fff',borderRadius:5}} onPress={()=>this.props.navigation.goBack()}>
                ...
                <View style={{flexDirection:'row',justifyContent:'space-between',alignItems:'center', marginTop:15}}>
                    ...
                    <TouchableOpacity style={styler.topNav2} onPress={()=>{this.props.navigation.navigate('filter')}}>
                ...
                <ScrollView  showsVerticalScrollIndicator={false}>
                 ...
                 <Text style={{fontSize:RFValue(13,580),fontWeight:'800',marginTop:17,marginBottom:10,color:'black'}}>  Search Result for 'Fruits'</Text>
