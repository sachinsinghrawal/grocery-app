        ...
        return(
            <View style={{paddingHorizontal:5,paddingVertical:10,borderBottomWidth:0.5,height:110,justifyContent:'space-between'}}>
                ...
                <View style={{flexDirection:'row',justifyContent:'flex-end'}}>
                    <TouchableOpacity style={{width:110,borderRadius:10,backgroundColor:'orange',justifyContent:'center',alignItems:'center',marginHorizontal:5,padding:3}} onPress={()=>this.props.navigation.navigate('orderDetails')}>
                        <Text style={Styler.txt2}>View Details</Text>
                    </TouchableOpacity>
                    <TouchableOpacity style={{width:110,borderRadius:10,backgroundColor:'orange',marginHorizontal:5,justifyContent:'center',alignItems:'center'}} onPress={()=>this.props.navigation.navigate('orderTrack')}>
                        <Text style={Styler.txt2}> Order Track</Text>
                    </TouchableOpacity>
                </View>
            </View>
        )
